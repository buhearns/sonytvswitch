...
object NetworkModule {
  ...
  @Qualifier @Retention(AnnotationRetention.BINARY) annotation class SessionTokens
  ...
  fun provideSessionManager(
      @SessionTokens tokenStore: DataStore<Preferences>,
      sonyServiceProvider: Provider<SonyService>
  ): SessionManager {
