...
import org.andan.android.tvbrowser.sonycontrolplugin.ui.screens.managecontrol.PropertyItem
...
fun PlayingContentInfoScreen(
  ...
  LaunchedEffect(Unit) { viewModel.fetchPlayingContentInfo() }

  Scaffold(
      topBar = {
        TopAppBar(
            title = { Text(text = stringResource(id = R.string.playing_content_screen_title)) },
            navigationIcon = {
...
@Composable
fun PlayingContentInfoContent(modifier: Modifier, playingContentInfo: PlayingContentInfo) {
